    ...
    if(Question!="" && Answer!="")
    {
      ...
      if(Level=="Easy")
      {
        const f = {
          ID: ID,
          CourseID: CourseID,
          EasyQuestions:{Question:Question,Type:Type,image:sessionStorage.getItem("image"),QAnswer:Answer}
          }
      ...
      else if(Level=="Medium")
      {
        const f = {
          ID: ID,
          CourseID: CourseID,
          MediumQuestions:{Question:Question,Type:Type,image:sessionStorage.getItem("image"),QAnswer:Answer}
          }
      ...
      else if(Level=="Hard")
      {
        const f = {
          ID: ID,
          CourseID: CourseID,
          HardQuestions:{Question:Question,Type:Type,image:sessionStorage.getItem("image"),QAnswer:Answer}
          }
...
<Button className="card text-center" style={{backgroundColor:'orange', color:"white", width:"20%",marginRight:20,textTransform:'none'}} onClick={()=>{history.push("/ViewBanks")}}>
  ...
  <div className="container-fluid p-5 text-center"> 
   ...
   <input type="button" value="Upload" onClick={()=>{saveFile()}} />
    ...
    <InputLabel id="demo-select-small">Correct Answer *</InputLabel>
    <Select
