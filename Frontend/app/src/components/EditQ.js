  ...
  const handleSubmit=()=>{
    ...
    if(Level=="Easy")
    {
      const f = {
        ...
        axios.post('http://localhost:8000/questionBanks/editEasys', f )
        .then(res => res.data)
    ...
    else if(Level=="Medium")
    {
      const f = {
        ...
        axios.post('http://localhost:8000/questionBanks/editMediums', f )
        .then(res => res.data)
        .then(data => "Question Added")
        .catch(err => toast("Fill in all required data"))
    }
    else if(Level=="Hard")
    {
      const f = {
        ...
        axios.post('http://localhost:8000/questionBanks/editHards', f )
        .then(res => res.data)
        .then(data => "Question Added")
        .catch(err => toast("Fill in all required data"))
    }
